		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#sapprj1projecthelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapprj1projecthelloworld-display": {
								"semanticObject": "sapprj1projecthelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.prj1.projecthelloworld",
									"url": sap.ui.require.toUrl("sap/prj1/projecthelloworld")
								}
							}
						}
					}
